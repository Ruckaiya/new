...
horVerSlider = {
  ...
  HNav: function() {
    $(".horizone-nav .next").on("click", function() {
      ...
      horVerSlider.HElement.addClass("").removeClass("zoomout");
      horVerSlider.addRemoveZoomCls(horVerSlider.ZoomeLevel);
      horVerSlider.HElement.find("li").css({
        width: horVerSlider.zoomedWidthe * horVerSlider.ZoomeLevel,
        height: horVerSlider.zoomedWidthe * horVerSlider.ZoomeLevel,
        left: 0,
        top: 0
      });
      horVerSlider.HElement.find("ul").css({
        width:
          horVerSlider.zoomedWidthe *
  ...
  verticalClick: function() {
    horVerSlider.VElement.find("li").on("click", function() {
      horVerSlider.ZoomeLevel = 1;
      horVerSlider.HElement.addClass("")
        .removeClass("zoomout")
  ...
  getZoomWidth: function() {
    ...
    if (horVerSlider.winWidth <= 400 && horVerSlider.winHeight <= 800) {
      horVerSlider.zoomedWidthe = $(".horVerSlider").data("mobileportrait");
    } else if (horVerSlider.winWidth <= 800 && horVerSlider.winHeight <= 400) {
      horVerSlider.zoomedWidthe = $(".horVerSlider").data("mobilelandscape");
    } else if (horVerSlider.winWidth <= 600 && horVerSlider.winHeight <= 768) {
      horVerSlider.zoomedWidthe = $(".horVerSlider").data("mobilelarge");
    } else if (horVerSlider.winWidth <= 768 && horVerSlider.winHeight <= 1024) {
      horVerSlider.zoomedWidthe = $(".horVerSlider").data("tabportrait");
    } else if (horVerSlider.winWidth <= 1024 && horVerSlider.winHeight <= 768) {
      horVerSlider.zoomedWidthe = $(".horVerSlider").data("tablandscape");
    } else if (horVerSlider.winWidth > 1024) {
      horVerSlider.zoomedWidthe = $(".horVerSlider").data("desktop");
    }
    return horVerSlider.zoomedWidthe;
  },
  HtoughMove: function() {
    $(horVerSlider.HElement)
    ...
    $(horVerSlider.HElement).on("touchmove", function(e2) {
      if (horVerSlider.HToughDown && horVerSlider.ZoomeLevel <= 1) {
        ...
        horVerSlider.zoomedWidthe = horVerSlider.HWidth;
  ...
  lightBox: function() {
      ...
      if ($(this).hasClass("zoomenable")) {
        setTimeout(function() {
          if (
            ...
            horVerSlider.zoomedWidthe = horVerSlider.getZoomWidth();
            ...
            if (
              horVerSlider.zoomedWidthe <
              horVerSlider.zoomedWidthe * horVerSlider.ZoomeLevel
            ) {
              horVerSlider.HElement.find("ul").css({
                width:
                  horVerSlider.zoomedWidthe *
                ...
                top: -((horVerSlider.zoomedWidthe * horVerSlider.ZoomeLevel) / 4)
              });
            } else {
              horVerSlider.HElement.find("ul").css({
                width:
    ...
    $(".close").on("click", function() {
      ...
      $("html").css({ overflow: "" });
      horVerSlider.zoomedWidthe = $("#horizon-slider").width();
  ...
  lightBoxZoom: function() {
    $("#horizon-slider ul li").on("drag", function(e, ui) {
      ...
      var blockDimention = horVerSlider.zoomedWidthe * horVerSlider.ZoomeLevel;
    });
    ...
    $(document).on("mouseup", ".fullscreen #horizon-slider", function() {
      if (
        ...
        if (horVerSlider.ZoomeLevel <= 3) {
          if (horVerSlider.HElement.hasClass("")) {
            horVerSlider.ZoomeLevel += 1;
      ...
      if (horVerSlider.ZoomeLevel == 3) {
        horVerSlider.HElement.addClass("zoomout").removeClass("");
